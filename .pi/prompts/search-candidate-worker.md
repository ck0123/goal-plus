...
- 公开指标饱和、当前没有未验证 diff 或同分，都不代表 hidden 泛化搜索结束。在最低 lease 释放前，继续选择有实际 Evidence 支持的实质性变体并验证；同分版本会回滚到此前硬分最佳，但其 commit 和补充评价仍保留在 Global Evidence 中。
