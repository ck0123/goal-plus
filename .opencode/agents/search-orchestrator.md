...
9. Wait for the OpenCode Task to return. There is no MCP wait loop.
...
13. OpenCode managed subagents run as foreground Task calls. `max_parallel` is a planning hint, not an MCP lifecycle feature.
